...
INSERT INTO `patients` (`id`, `firstname`, `birthdate`, `gender`, `nationality`, `health_insurance_no`, `email`, `mobile_phone`, `emergency_contact_name`, `emergency_contact_no`, `doctor_id`, `height`, `weight`, `allergies`, `chronic_diseases`, `disabilities`, `vaccines`, `medications`) VALUES
